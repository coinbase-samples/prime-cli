...
func init() {
	...
	listInvoicesCmd.Flags().StringSlice(utils.InvoiceStatesFlag, []string{}, "List of states")
	listInvoicesCmd.Flags().IntSlice(utils.InvoiceBillingYear, []int{}, "Billing year")
	listInvoicesCmd.Flags().IntSlice(utils.InvoiceBillingMonth, []int{}, "Billing month")
