...
func init() {
	...
	createOrderCmd.Flags().String(utils.LimitPriceFlag, "", "Limit price for the order")
	...
	createOrderCmd.Flags().String(utils.ClientOrderIdFlag, "", "Client order id value. Autogenerated if blank")
