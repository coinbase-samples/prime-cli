...
func init() {
	...
	createOrderPreviewCmd.Flags().StringP(utils.SideFlag, "", "", "Order side (Required)")
	createOrderPreviewCmd.Flags().StringP(utils.ProductIdFlag, "", "", "ID of the product (Required)")
	createOrderPreviewCmd.Flags().StringP(utils.TypeFlag, "", "", "Type of the order (Required)")
	createOrderPreviewCmd.Flags().StringP(utils.BaseQuantityFlag, "", "", "Order size in base asset units")
	createOrderPreviewCmd.Flags().StringP(utils.QuoteValueFlag, "", "", "Order size in quote asset units")
	createOrderPreviewCmd.Flags().StringP(utils.TimeInForceFlag, "", "", "Determine order fill strategy")
	createOrderPreviewCmd.Flags().StringP(utils.LimitPriceFlag, "", "", "Limit price for the order")
