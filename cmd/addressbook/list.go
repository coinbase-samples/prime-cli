...
func init() {
	...
	listAddressBookCmd.Flags().StringP(utils.SymbolFlag, "s", "", "Currency symbol for filtering address book entries")
	listAddressBookCmd.Flags().StringP(utils.SearchFlag, "e", "", "Search term for filtering address book entries")
