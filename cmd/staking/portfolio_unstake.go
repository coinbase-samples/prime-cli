...
var portfolioUnstakeCmd = &cobra.Command{
	Use:   "portfolio-unstake",
	Short: "Initiates a portfolio-level unstake request",
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		response, err := svc.PortfolioUnstake(ctx, request)
		if err != nil {
			return fmt.Errorf("cannot initiate portfolio unstake: %w", err)
		}
...
func init() {
	Cmd.AddCommand(portfolioUnstakeCmd)
	utils.AddPortfolioIdFlag(portfolioUnstakeCmd)
