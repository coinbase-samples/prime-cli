...
var getPortfolioCreditInfoCmd = &cobra.Command{
	Use:   "get-credit-info",
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		response, err := getPortfolioCreditInfo(svc, request)
		if err != nil {
			return err
		}
...
func init() {
	Cmd.AddCommand(getPortfolioCreditInfoCmd)

	utils.AddPortfolioIdFlag(getPortfolioCreditInfoCmd)
}
