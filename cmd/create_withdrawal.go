...
func init() {
	...
	createWithdrawalCmd.Flags().StringP(utils.FormatFlag, "z", "false", "Pass true for formatted JSON. Default is false")
	createWithdrawalCmd.Flags().StringP(utils.PortfolioIdFlag, "", "", "Portfolio ID. Uses environment variable if blank")
	createWithdrawalCmd.Flags().StringP(utils.IdempotencyKeyFlag, "k", "", "Idempotency key value. Autogenerated if blank")
