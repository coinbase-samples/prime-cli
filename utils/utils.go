...
func AddClientOrderId(cmd *cobra.Command) {
	cmd.Flags().String(ClientOrderIdFlag, "", "Client order id value. Autogenerated if blank")
}

func AddLimitPriceFlag(cmd *cobra.Command) {
	cmd.Flags().String(LimitPriceFlag, "", "Limit price for the order")
}

func AddQuoteValueFlag(cmd *cobra.Command) {
	cmd.Flags().String(QuoteValueFlag, "", "Order size in quote asset units")
}

func AddOrderSideFlag(cmd *cobra.Command) {
	cmd.Flags().String(SideFlag, "", "Order side, e.g. BUY (Required)")
}

func AddBaseQuantityFlag(cmd *cobra.Command) {
	cmd.Flags().String(BaseQuantityFlag, "", "Order size in base asset units")
}
...
func AddEntityIdFlag(cmd *cobra.Command) {
	cmd.Flags().String(EntityIdFlag, "", "Entity ID. Uses environment variable if blank")
}

func AddIdempotencyKeyFlag(cmd *cobra.Command) {
	cmd.Flags().String(IdempotencyKeyFlag, "", "Idempotency key value. Autogenerated if blank")
}

func AddStartEndFlags(cmd *cobra.Command) {
	cmd.Flags().String(StartFlag, "", "Start time in RFC3339 format")
	cmd.Flags().String(EndFlag, "", "End time in RFC3339 format")
}
